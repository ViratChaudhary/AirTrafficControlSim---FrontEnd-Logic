...
public class Gate implements Encodable {
     ...
     *
     * @param obj Returns true if and only if this gate is equal to the other given gate.
    ...
    public boolean equals(Object obj) {
        ...
        Gate otherGate = (Gate) obj;
        return this.gateNumber == otherGate.gateNumber;
    }
    ...
    public int hashCode() {
        int result = 9;
        return (29 * result * this.gateNumber);
    }
    ...
    public String encode() {
        ...
        joiner.add(String.valueOf(this.gateNumber));
        joiner.add(this.aircraftAtGate == null ? "empty" : aircraftAtGate.getCallsign());
