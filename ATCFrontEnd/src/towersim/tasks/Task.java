...
public class Task implements Encodable {
     ...
     * If this is a LOAD-type task, the format of the string to return is LOAD@loadPercent
     *
     * @return encoded string representation of this task
     */
    public String encode() {
        if (this.type == TaskType.LOAD) {
            return this.type.name() + "@" + this.loadPercent;
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.type.equals(otherTask.type)
                && this.loadPercent == otherTask.loadPercent;
    }
    ...
    public int hashCode() {
        int result = 11;
        result = (21 * result * this.type.hashCode())
                + (21 * result * this.loadPercent);
        return result;
    }
}
