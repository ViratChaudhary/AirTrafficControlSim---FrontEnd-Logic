...
public abstract class Aircraft implements OccupancyLevel, Tickable, EmergencyState, Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        return this.callsign.equals(otherAircraft.callsign)
                && this.characteristics.equals(otherAircraft.characteristics);
    }
    ...
    public int hashCode() {
        int result = 3;
        result = (19 * result * this.callsign.hashCode())
                + (19 * result * this.characteristics.hashCode());
        return result;
    }
